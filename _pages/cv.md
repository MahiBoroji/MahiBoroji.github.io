...
{% include base_path %}
[Download CV](https://drive.google.com/file/d/1xYNgsRp8xCVPLQtVda14PKhQKaJA_kY6/view?usp=sharing)
...
* M. Boroji, V. Danesh, I. Kao, A. Fakhari, "[Motion Planning for Object Manipulation by Edge-Rolling](https://ieeexplore.ieee.org/document/10802581)," *IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)*, 2024.
...
======
* Crazyflie Project:
  * Developed an advanced autonomous flight system in Python for Crazyflie drones featuring obstacle avoidance, dynamic path planning (using D* lite), and precision landing capabilities.[[report]](https://docs.google.com/presentation/d/1xa3mldBdaXYvfkTTv_e3aqU2L0KCLq8pDLhZfHjOtOo/edit?usp=sharing)[[GitHub]](https://github.com/VahidDanesh/cfpilot)
* pandaSim Project:
